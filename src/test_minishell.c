...
/*
DESCRIPTION:
	Parses the input string into a command tree by tokenizing, parsing tokens,
	and building the command list. Returns the command tree on success,
	NULL on failure.
*/
...
/*
DESCRIPTION:
	Initializes PWD, OLDPWD, and HOME environment variable pointers at startup.
	Updates PWD and OLDPWD values.
*/
